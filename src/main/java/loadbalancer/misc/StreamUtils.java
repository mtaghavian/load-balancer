...
public class StreamUtils {
    ...
    public static int copy(InputStream is, OutputStream os, boolean closeInput, boolean closeOutput) throws IOException {
    ...
    public static String encrypt(String text, String key) throws Exception {
        ...
        cipher.init(Cipher.ENCRYPT_MODE, new SecretKeySpec(digest.digest(key.getBytes("UTF-8")), "AES"), new IvParameterSpec(new byte[16]));
    ...
    public static String decrypt(String text, String key) throws Exception {
        MessageDigest digest = MessageDigest.getInstance("MD5");
        Cipher cipher = Cipher.getInstance("AES/CBC/PKCS5PADDING");
        cipher.init(Cipher.DECRYPT_MODE, new SecretKeySpec(digest.digest(key.getBytes("UTF-8")), "AES"), new IvParameterSpec(new byte[16]));
    ...
    public static String toHumanReadableSIPrefixes(long size) {
        if (size < 0) throw new IllegalArgumentException("Invalid file size: " + size);
    ...
    public static String getUserAddressExtended(HttpServletRequest req) {
        StringBuilder sb = new StringBuilder();
        String separator = ": ";
        String[] IP_HEADERS = {"X-Forwarded-For", "Proxy-Client-IP", "WL-Proxy-Client-IP", "HTTP_X_FORWARDED_FOR", "HTTP_X_FORWARDED", "HTTP_X_CLUSTER_CLIENT_IP", "HTTP_CLIENT_IP", "HTTP_FORWARDED_FOR", "HTTP_FORWARDED", "HTTP_VIA", "REMOTE_ADDR"};
